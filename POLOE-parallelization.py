...
Parallelization and automation of the run of the POLOE-code.py script for
...
def run_scripts(num_instancias, tipo_simula, valores_J, valores_q, valores_simulaciones):
    ...
    def run_pyfile(params, carpeta):
        comando = f"python POLOE-code.py --param1 {params['param1']} --param2 {params['param2']} --param_uni1 {params['param_uni1']} --param_uni2 {params['param_uni2']} --simu_p_1 {params['simu_p_1']} --simu_p_2 {params['simu_p_2']} --simu_p_3 {params['simu_p_3']} --output {carpeta}"
